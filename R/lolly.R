#' @title Draw lolly plots.
#' @description The S3 method [lolly()] produces a lolly plot to visually summarise the results of a simulation study analysed using [simsum()].
